class PurchaseItemsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to purchase_items_path, status: :see_other, notice: "Purchase item was successfully destroyed." }
  ...
  private
    ...
    def purchase_item_params
      params.expect(purchase_item: [ :purchase_id, :digital_asset_id, :price_at_purchase ])
    end
end
